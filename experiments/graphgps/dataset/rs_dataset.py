...
class RS(ChiralDatasetBase):
    r"""
    Dataset for R/S classification task from ChIRo paper. Inspired by `ZINC` dataset from torch_geometric.graphgym.
    ...
    def __init__(self, root, single_conformer, mask_chiral_tags, split='train', pre_transform_name=None,
